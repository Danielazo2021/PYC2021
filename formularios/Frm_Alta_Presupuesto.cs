...
namespace CarpinteriaApp.formularios
{
    public partial class Frm_Alta_Presupuesto : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            /*
            if (nudCantidad.Text == "" || !int.TryParse(nudCantidad.Text, out _)) // el out del final es si el try parse devuelve algo lo desestime y lo anule, osea lo pase por encima sin hacer nada y no lo guarde en ninguna variable
            {
            ...
            dgvDetalles.Rows.Add(new object[] { item.Row.ItemArray[0], item.Row.ItemArray[1], item.Row.ItemArray[2], nudCantidad.Text });
